...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        Hello, I&apos;m <span className="font-bold">Omar Jouied</span>.<br /> I&apos;m a{" "}
      ...
      <motion.div
        className="flex flex-wrap items-center justify-center gap-4 px-4 text-lg font-medium"
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{
          delay: 0.1,
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a
            ...
            href="https://linkedin.com/in/omar-jouied-687307251/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
          ...
          <a
            ...
            href="https://github.com/OmarJouied"
            target="_blank"
          >
            <FaGithubSquare />
          </a>
